$('document').ready(function () {
        ...
        function checkWinOrLose() {
                ...
                if (defenderHealth <= 0 && enemyChars.length == 0 && playerHealth > 0) {
                        ...
                        $('.attack').toggleClass('invisible');
                        $('.commentaryBoxOne').empty();
                        $('.commentaryBoxTwo').text(`You defeated ${defenderFullName}!`)
                        promptWinOrLose(true);
                        ...
                        $('body').off('click', '.attack');
                        $('.attack').toggleClass('invisible');
                        $('.commentaryBoxOne').text(`You died but...`);
                        $('.commentaryBoxTwo').text(`You defeated ${defenderFullName}!`)
                        promptWinOrLose(true);
        ...
        function promptWinOrLose(e) {
                ...
                (e === true) ? imgSrc = "./assets/images/you-win-oval.png" : imgSrc = "./assets/images/game-over-oval.png";
                ...
                $prompt.html(`'<img src="${imgSrc}" width="426px" height="220px">'`).css({ "position": "fixed", "top": "40vh", "left": "50vw", "transform": "translate(-50%, -50%)", "z-index": "100" })
                $restart.css({ "position": "fixed", "top": "65%", "left": "50%", "font-size": "2rem", "cursor": "pointer", "z-index": "20", "transform": "translate(-50%, -50%)" });
